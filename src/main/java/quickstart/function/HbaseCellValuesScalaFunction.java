...
public class HbaseCellValuesScalaFunction extends ScalarFunction {
    String zkHosts = "master.northking.com,slave1.northking.com,slave2.northking.com";
    String zkPort = "2181";

    public String eval(String hTableName, String familyName, String cellName, String rowKey) throws Exception {
        ...
        return getTableCellsByRowKey(familyName, cellName, rowKey, table);

    }


    public String getTableCellsByRowKey(String familyName, String cellName, String rowKey, Table table) throws IOException, ClassNotFoundException {
        Scan scan = new Scan();
